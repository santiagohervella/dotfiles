-- This entire file was 100% taken from here:
-- https://github.com/ecosse3/nvim/blob/master/lua/plugins/dap.lua
-- Since I'm not sure how much I care about breakpoints in my workflow today
-- I didn't want to spend tons of time implementing this myself
return {
	{
		"szw/vim-maximizer",
		cmd = "MaximizerToggle",
