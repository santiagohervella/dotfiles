...
- [tpope/vim-obsession](https://github.com/tpope/vim-obsession)
  - My idea was to use it to dynamically suspend nvim whenever I navigated away from the tmux session it was running in, but due to the startup time of LSPs, this was not a viable idea
- [axsaucedo/neovim-power-mode](https://github.com/axsaucedo/neovim-power-mode)
  - Combo counter for typing code. Fun but too crazy
